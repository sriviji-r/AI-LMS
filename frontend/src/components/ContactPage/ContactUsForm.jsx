...
const ContactUsForm = () => {
  ...
  return submitted ? (
    <div className="flex flex-col items-center justify-center gap-4 py-10 text-center">
      <div className="flex h-16 w-16 items-center justify-center rounded-full bg-green-900/40 border border-green-500">
      ...
      <button
        ...
        className="mt-2 rounded-lg border border-richblack-600 px-5 py-2 text-sm text-richblack-300 hover:border-yellow-400 hover:text-yellow-400 transition-all"
      >
