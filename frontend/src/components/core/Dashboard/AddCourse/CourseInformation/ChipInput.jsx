...
export default function ChipInput({
  ...
  const addChip = () => {
    const chipValue = inputRef.current.value.trim()
    ...
    <div className="flex flex-col space-y-2">
      ...
      <div className="flex gap-2">
        ...
        <button
          type="button"
          onClick={addChip}
          className="rounded-md bg-yellow-400 px-4 py-2 text-sm font-semibold text-richblack-900 hover:bg-yellow-300 transition-all"
        >
          Add
        </button>
      </div>
